...
# 定义文件路径和起止行号
metrics_log_file = '/Users/suenyvan/Desktop/DataSet2/9.10cloud0minUpdate/metrics_log.csv'
data_file = '/Users/suenyvan/Desktop/DataSet2/9.10cloud0minUpdate/data.csv'    
start_metrics_line = 1182  # 从第1300-2行开始，因为pandas的索引从0开始
start_data_line = 84       # 从第86行开始

...
# 读取CSV文件
csv_file = '/Users/suenyvan/Desktop/DataSet2/9.10default_limits_cloud/metrics_log1.csv'
...
plt.tight_layout()
plt.savefig('/Users/suenyvan/Desktop/DataSet2/9.10default_limits_cloud/cut7-18.pdf')

...
# 读取CSV文件
df = pd.read_csv('/Users/suenyvan/Desktop/pa/newpredictioncompare/Cloud.csv')
...
# 显示图表
plt.tight_layout()
plt.savefig('/Users/suenyvan/Desktop/pa/newpredictioncompare/cloudpredictcompare.png')

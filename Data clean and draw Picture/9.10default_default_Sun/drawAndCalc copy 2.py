...
# 读取CSV文件
csv_file = '/Users/suenyvan/Desktop/DataSet2/9.10default_default_Sun/metrics_log1.csv'
...
plt.legend(prop={'size': 21, 'weight': 'bold'})  # 同时设置字体大小和加粗
...
plt.tight_layout()
plt.savefig('/Users/suenyvan/Desktop/DataSet2/9.10default_default_Sun/cut_7-18.pdf')

...
bars_sunny = ax.bar(index, compare_sunny, bar_width, label='Compare to Sunny', color='lightblue')
bars_cloudy = ax.bar(index + bar_width, compare_cloudy, bar_width, label='Compare to Cloudy', color='pink')
...
# 设置 x 轴和 y 轴标签
ax.set_xlabel('Baselines', fontsize=30)
...
# 显示图形
plt.tight_layout()
plt.savefig('/Users/suenyvan/Desktop/pa/finialresultcompare/saving.png')

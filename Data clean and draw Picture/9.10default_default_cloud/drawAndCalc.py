...
textstr = f"Total energy consumed: {total_energy_consumed} Watts\n" \
          ...
          f"Total absolute difference (|blue line - yellow line|): {total_absolute_difference:.2f} Watts"
props = dict(boxstyle='round', facecolor='wheat', alpha=0.5)
plt.text(0.05, 0.95, textstr, transform=plt.gca().transAxes, fontsize=12,
         verticalalignment='top', bbox=props)

plt.tight_layout()
plt.savefig('/Users/suenyvan/Desktop/DataSet2/9.10default_default_cloud/power_consumption_over_time1.png')

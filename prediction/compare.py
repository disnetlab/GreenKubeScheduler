...
# 加载预测结果
predicted_df = pd.read_csv('/Users/suenyvan/Desktop/DataSet2/solarPrediction/7day_predicted_for_2017.csv', header=None)

# 加载实际结果
actual_df = pd.read_csv('/Users/suenyvan/Desktop/DataSet2/solarPrediction/solar_data_normalized_cleaned.csv')
